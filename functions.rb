...
# Write a function that returns the sum of the three numbers passed
# add_three
...
# write a function that gives string with all the vowels stripped out
# disemvowel
...
def all_elements_except_first_3 string
